...
"""
        ...
        # Test with file:class format
        config_with_colon = {
            "file": f"{test_file}:TestClass",
            "args": ["test_value_2"]
        }
        obj2 = create_instance(config_with_colon)
        assert obj2.value == "test_value_2"
    ...
    def test_create_instance_invalid_configs(self):
        ...
        with pytest.raises(ValidationError, match="'class' must be a string"):
            create_instance({
                "module": "datetime",
                "class": 123
            })
    ...
    def test_create_instance_not_a_class(self):
        # Test when the imported object is not a class
        config = {
            "module": "math",
            "class": "sqrt"
        }
...
class TestCreateCallable:
    def test_create_callable_function(self):
        """Test creating a function callable."""
        config = {
            "module": "math",
            "name": "sqrt"
        }
    ...
    def test_create_callable_class_with_call(self):
        """Test creating a callable from class with __call__."""

        # Define test class in fixtures/test_classes.py:
        # class CallableClass:
    ...
    def test_create_callable_instance_method(self):
        """Test creating a callable from instance method."""
    ...
    def test_create_callable_partial(self):
        """Test creating a partial function."""
        config = {
            "partial": {
                "function": {
                    "module": "operator",
    ...
    def test_create_callable_nested(self):
        """Test creating a callable with nested configurations."""
    ...
    def test_create_callable_errors(self):
        """Test error handling in create_callable."""
