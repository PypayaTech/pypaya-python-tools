...
from pypaya_python_tools.code_analysis.string_pattern import StringPatternAnalyzer
...
from pypaya_python_tools.code_analysis.chain import SecurityAnalyzerChain
